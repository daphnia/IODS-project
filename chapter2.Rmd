...
GGally and ggplot2 produces another, way better, scatterplot matrix:
```{r echo=T, fig.cap="Here red color marks females, blue color marks males.",fig.height=9, fig.width=12}
library(ggplot2)
library(GGally)
